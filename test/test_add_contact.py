...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_new_contact(wd, Contact("John", "Mark", "Smith", "Mike", "Dr", "adada", "Street", "500055555", "666666666",
                                "777777777", "11111111111", "sadadas@sadaa.com", "sadadas2@sadaa.com",
                                "sadadas3@sadaa.com", "www.home.pl", "1999", "2000", "Street2", "Home", "Bye"))
        self.return_to_add_new_contact_page(wd)
        self.logout(wd)
    ...
    def return_to_add_new_contact_page(self, wd):
        # return to add new
